...
for i, batch in enumerate(train):
    ...
    pred_0 = model(images)
    utils.my_csv.tensor_to_csv(pred_0, 'runs/csv_to_weights/pred_0')
    utils.my_csv.weights_to_csv(model, 'runs/csv_to_weights/pre')

    utils.my_csv.csv_to_weights(model, 'runs/csv_to_weights/tensorflow_model_weights')
    
    pred_1 = model(images)
    utils.my_csv.tensor_to_csv(pred_1, 'runs/csv_to_weights/pred_1')
    utils.my_csv.weights_to_csv(model, 'runs/csv_to_weights/post')

    utils.my_csv.csv_to_weights(model, 'runs/csv_to_weights/pre')

    pred_2 = model(images)
    utils.my_csv.tensor_to_csv(pred_2, 'runs/csv_to_weights/pred_2')
